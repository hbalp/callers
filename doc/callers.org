...
// End:
   ...
   #+END_SRC
**** TODO Callers analysis process		   :analysis:callers:process:
...
// callers analysis
"local metadata" [ label="local symbols & calls\njson files", shape="box", color=black ]
"extcallees metadata" [ label="local calls & ext callees\njson files", shape="box", color=black ]
"extcallers metadata" [ label="local & ext callers/callees\njson files", shape="box", color=black ]
"json files list" [ label="json files lists\nin dirs", shape="box", color=black ]
"defined symbols" [ label="defined symbols list\nin dirs", shape="box", color=black ]
...
"launch test" [ label="1) launch test\n(bash)", shape=oval, color=black, labelloc=l ]
"launch analysis" [ label="2) launch callers analysis\ncmake-callers | scan-callers", shape=oval, color=black ]
//"launch cmake-callers" [ label="cmake-callers analysis\n(bash)", shape=oval, color=black ]
//"launch scan-callers" [ label="scan-callers analysis\n(bash)", shape=oval, color=black ]
"list json files" [ label="3) list json files\n(OCAML)", shape=oval, color=black ]
"list defined symbols" [ label="4) list defined symbols\n(OCAML)", shape=oval, color=black ]
"add extern callees" [ label="5) add external callees\n(OCAML)", shape=oval, color=black ]
"add extern callers" [ label="6) add external callers\n(OCAML)", shape=oval, color=black ]
"json to dot" [ label="7) generate dot graphs\n(OCAML)", shape=oval, color=black ]
"dot to image" [ label="8) generate images\n(bash)", shape=oval, color=black ]
