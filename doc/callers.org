...
* Functioning and user interface
   ...
   (function, file, directory, libraries, application), in order to help the en-user focusing of specifi parts of the software.
   
   To understand how the Callers plugin can be used by an end-user, you have first to know it works and how it is stuctured,
