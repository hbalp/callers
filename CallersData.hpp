...
namespace CallersData 
{
  ...
  class File
  {
    public:
      ...
      void add_defined_function(std::string func, std::string sign);
  ...
  class FctCall
  {
    ...
    public:
      FctCall(std::string caller_id, std::string caller_sign, 
  ...
  {
    public:
      Fct(const char* fct, const char* sign);
      Fct(std::string fct, std::string sign);
