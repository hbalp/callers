...
** Callers OCAML backends
  ...
  2) browsing the generated lists of defined symbols in each directory, we can now lookup for the definition
   ...
   #+END_SRC
** TODO Example [0/1]
   - [-] Illustrate the functioning of the plug-in through a small example [1/3]
     - [X] source code
     - [ ] steps to analyse it
...
**** function call paths from A::A() to c()
     #+BEGIN_SRC dot :tangle A_A.c.c2c.dot
digraph G {
  "int c()";
  "void A::A()";
  "void B::B()";
...
**** function call paths from main() to B::b()
     #+BEGIN_SRC dot :tangle main.B_b.c2c.dot
digraph G {
  "int c()";
  "int main()";
  "void A::A()";
...
*** step 3: list of generated json files in test directory
