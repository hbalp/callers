...
*** json file extension [0/2]
    ...
    1. [ ] add a *virtuality* keyword extension 
...
**** step 1. _to produce the virtuality flag for each virtual method declaration_
...
*** TODO [#A] Add an OCAML backend to build class inheritance graphs
...
**** TODO Add the *add_inherited* OCAML backend to complete declared base classes with their list of children's classes
**** TODO Add an *class_diagram* OCAML backend to generate class diagrams
