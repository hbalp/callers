...
then
    ...
    cmake ..
    make clean
    kwinject --update -o ${test}.kwinject make
    kwbuildproject --incremental --url http://localhost:8090/${test} --tables-directory /analysis/klocwork/tables/${test} ${test}.kwinject
