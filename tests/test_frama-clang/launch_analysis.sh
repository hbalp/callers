...
then
    ...
    source function_callgraph.sh callees `pwd`/simple.c "simple_c" "int main(int, ((char)*)*)" files
    #function_callgraph.native callees `pwd`/simple.cpp "simple_cpp" "int main(int, ((char)*)*)" files
